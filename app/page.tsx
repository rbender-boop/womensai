                              ...
                              {fq.options.map((opt) => {
                                ...
                                return (
                                  <button key={opt} type="button"
                                    ...
                                    style={selected ? { background: '#9B4163', color: '#fff', borderColor: '#9B4163' } : { background: 'rgba(253,245,248,0.8)', color: '#7A6E67', borderColor: 'rgba(212,167,185,0.5)' }}>
                                    {opt}
                                  </button>
                                );
                              })}
            ...
            <div className="mt-5 flex flex-wrap gap-2 justify-center">
              {EXAMPLES.map((ex) => (
                <button key={ex}
                  ...
                  style={{ background: 'rgba(255,255,255,0.7)', border: '1px solid rgba(212,167,185,0.38)', color: '#7A6E67', backdropFilter: 'blur(4px)' }}>
                  {ex}
                </button>
              ))}
            </div>
              ...
              {stripDone ? (
                ...
                <>
                  ...
                  <p className="text-sm mb-8 mx-auto" style={{ color: '#7A6E67', maxWidth: '380px', lineHeight: 1.75 }}>
                    Your questions build context. Every answer gets sharper and more personalized.<br />Your questions always remain anonymous. No credit card. No commitment.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-3 justify-center" style={{ maxWidth: '420px', margin: '0 auto' }}>
                    <input type="email" placeholder="your@email.com" value={stripEmail}
                      ...
                      style={{ background: 'rgba(255,255,255,0.88)', border: '1.5px solid rgba(212,167,185,0.5)', borderRadius: '100px', color: '#1C1714' }} />
                    <button onClick={handleStripSignup} disabled={stripLoading}
                      className="text-sm font-semibold px-7 py-3.5 disabled:opacity-60 shrink-0"
                      style={{ background: 'linear-gradient(135deg, #9B4163, #7A3050)', color: '#fff', borderRadius: '100px', boxShadow: '0 4px 18px rgba(139,48,88,0.32)' }}>
